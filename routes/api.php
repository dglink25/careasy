...
use Illuminate\Support\Facades\Broadcast; // ← AJOUT IMPORTANT
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ✅ NOUVELLE ROUTE PUSHER - Authentification pour les WebSockets
...
// Routes publiques de paiement (webhook)
